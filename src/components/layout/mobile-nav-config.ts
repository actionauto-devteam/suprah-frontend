...
export const dealershipMobileModules: BottomNavItem[] = [
    ...
    // Apps
    { label: "Suprah Calendar", href: "/crm/suprah-calendar", icon: CalendarDays },
    { label: "Suprah Space", href: "/crm/supra-space", icon: MessageSquare },
    { label: "Suprah YapLine", href: "/crm/yapline", icon: RadioTower },
    { label: "Suprah One Desk", href: "/crm/suprah-mail", icon: Mail },
    { label: "Feeds", href: "/crm/feeds", icon: Rss },
    { label: "Conversations", href: "/crm/conversations", icon: PlusSquare },
    { label: "Project Management", href: "/project", icon: FolderKanban },

    // Services
    { label: "All Inventory", href: "/inventory", icon: Car },
    { label: "Transportation", href: "/transportation", icon: Truck },
    { label: "Suprah Radar", href: "/suprah-radar", icon: Radar },
    { label: "Driver Tracker", href: "/driver-tracker", icon: User },
    { label: "SuprahPay", href: "/billing", icon: CreditCard },
