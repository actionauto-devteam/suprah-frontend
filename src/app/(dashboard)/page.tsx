...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard-scope relative w-full max-w-none min-w-0 overflow-x-clip p-3 sm:p-6 lg:p-8 space-y-5 sm:space-y-6 min-h-full pb-24 md:pb-12 animate-in fade-in duration-500">
