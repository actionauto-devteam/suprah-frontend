        ...
        <div className="relative bg-linear-to-br from-primary/80 via-primary/60 to-primary/40 px-4 sm:px-6 pt-5 sm:pt-8 pb-4 sm:pb-6">
          <div className="flex items-start gap-3 sm:gap-5">
            <div className="relative shrink-0">
              <Avatar
                className={cn(
                  "size-16 sm:size-20 ring-4 ring-white/60 ring-offset-2 ring-offset-primary/50 shadow-xl",
                )}
              >
                <AvatarImage src={profile.avatar} />
                <AvatarFallback className="text-2xl font-black bg-primary/30 text-white">
                  {profile.name?.[0]}
                </AvatarFallback>
              </Avatar>
              <span
            ...
            <div className="flex-1 min-w-0 pb-1">
              <div className="flex items-center gap-2 flex-wrap mb-1">
                ...
                <Badge
                  className={cn(
                    "text-[9px] font-black px-1.5 h-4 uppercase tracking-wide border",
            ...
            <Badge
              variant="outline"
              className={cn(
                "text-[10px] font-semibold px-2 py-1 gap-1.5 border shrink-0 self-start",
                S.badge[status],
              )}
            >
        ...
        <div className="p-5 sm:p-7 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {infoItems.map((item) => (
                  <div
                    key={item.label}
                    className="flex items-center gap-3 p-3.5 rounded-lg bg-muted/30 border border-border/30"
                  >
          ...
          {profile.lastActive && (
            <div className="flex items-center gap-2 text-xs text-muted-foreground/60 px-0.5">
              ...
              {formatDistanceToNow(parseISO(profile.lastActive), {
                addSuffix: true,
              })}
            </div>
          )}
    ...
    <>
      ...
      >
        <SheetContent className="w-full sm:max-w-xl overflow-y-auto">
          <SheetHeader
            className={cn(!profile && "sr-only", "px-5 sm:px-6 pb-0")}
          >
            ...
            <div className="space-y-5 mt-4 px-5 sm:px-6 pb-6">
              ...
              <div className="flex items-start gap-4 p-5 rounded-2xl bg-muted/20 border border-border/30">
                <div className="relative shrink-0">
                  <Avatar
                    className={cn(
                      "size-18 ring-2 ring-offset-2 ring-offset-background",
                      S.ring[status],
                    )}
                  >
                    <AvatarImage src={profile.avatar} />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 flex-wrap mb-1.5">
                    ...
                    <Badge
                      variant="outline"
                      className={cn(
                        "text-[10px] font-semibold h-4 px-1.5 gap-1 border",
                        S.badge[status],
                      )}
                    >
                      <StatusDot s={status} />
                  ...
                  {profile.customStatus && (
                    <p className="text-[11px] italic text-muted-foreground/50 mt-1">
                      "{profile.customStatus}"
                    </p>
                  )}
                </div>
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/50 mb-2 px-0.5">
                  Work
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    ...
                    >
                      <item.icon
                        className={cn("size-3.5 shrink-0", item.color)}
                      />
                      <div className="min-w-0">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    ...
                    >
                      <item.icon
                        className={cn("size-4 shrink-0", item.color)}
                      />
                      <div className="min-w-0">
                        <p className="text-[9px] font-bold uppercase tracking-wide text-muted-foreground/50">
                          {item.label}
              ...
              <div className="rounded-xl bg-muted/20 border border-border/20 px-4 py-4">
                ...
                <p className="text-xs leading-relaxed text-muted-foreground">
                  {profile.personalInfo?.bio || (
                    <span className="italic opacity-50">No bio added yet.</span>
                  )}
                </p>
              </div>
    ...
    >
      <div className="relative shrink-0">
        ...
        >
          ...
          <AvatarFallback className="text-sm font-black bg-muted/60">
            {member.name[0]}
          </AvatarFallback>
        </Avatar>
        <span
          className={cn(
            "absolute -bottom-0.5 -right-0.5 size-3 rounded-full border-[1.5px] border-background",
            S.dot[status],
          )}
        />
      </div>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5 mb-0.5">
          ...
          <Badge
            variant="outline"
            className={cn(
              "text-[9px] font-black px-1.5 h-4 uppercase tracking-wide border shrink-0",
              ROLE_STYLE[member.role] ?? ROLE_STYLE.employee,
            )}
          >
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {member.customStatus && (
            <span className="text-[10px] italic text-muted-foreground/40 truncate">
              "{member.customStatus}"
            </span>
          )}
        </div>
      ...
      <div className="flex flex-col items-end gap-1 shrink-0">
        {leaveToday ? (
          ...
          <Badge
            variant="outline"
            className={cn(
              "text-[10px] font-semibold h-5 px-2 gap-1 border",
              S.badge[status],
            )}
          >
            <StatusDot s={status} />
...
function NoteCard({
  ...
  const isNonGeneral =
    note.announcementType && note.announcementType !== "general";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow:
            "0 2px 4px rgba(0,0,0,0.08), 0 6px 18px rgba(0,0,0,0.14), 0 1px 2px rgba(0,0,0,0.06)",
        }}
      >
        {isNonGeneral && (
          <div
        ...
        >
          <div className="flex-1 min-w-0">
            {note.emoji && (
              <span className="text-2xl leading-none block mb-1.5">
                {note.emoji}
              </span>
            )}
            {note.title && (
          ...
          >
            {note.pinned && !isAdmin && (
              <Pin className="size-3 text-foreground/30 p-0.5" />
            )}
            {isAdmin && (
              <Tooltip>
...
function OverviewDashboard({
  ...
  const busy = members.filter(
    (m) => m.onlineStatus === "busy" || m.onlineStatus === "do_not_disturb",
  ).length;
  const away = members.filter(
    (m) => m.onlineStatus === "away" || m.onlineStatus === "idle",
  ).length;
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          },
          {
            ...
            bg: "bg-green-50 dark:bg-green-950/30 border-green-200/60 dark:border-green-800/30",
          },
          {
            label: "Away / Busy",
            value: away + busy,
          ...
          <div
            key={s.label}
            className={cn(
              "flex items-start gap-3 p-4 sm:p-5 rounded-xl border",
              s.bg,
            )}
          >
            <div
              className={cn(
                "mt-0.5 p-1.5 rounded-lg bg-background/60",
                s.color,
              )}
            >
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground mt-0.5 leading-tight">
                {s.label}
              </p>
                  ...
                  <TooltipTrigger asChild>
                    ...
                    >
                      ...
                      <div className="text-center">
                        <p className="text-[10px] font-semibold max-w-14 truncate leading-tight">
                          {m.name.split(" ")[0]}
                        </p>
                        <p
                          className={cn("text-[9px] font-bold leading-tight", {
                            "text-green-600 dark:text-green-400":
                              st === "online",
                            "text-red-500 dark:text-red-400":
                              st === "busy" || st === "do_not_disturb",
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
          {deptGroups.map(({ key, label, members: dm }) => {
            const dOnline = dm.filter(
              (m) => m.onlineStatus === "online",
            ).length;
            const dBusy = dm.filter(
              (m) =>
                m.onlineStatus === "busy" ||
                m.onlineStatus === "do_not_disturb",
            ).length;
            const dAway = dm.filter(
              (m) => m.onlineStatus === "away" || m.onlineStatus === "idle",
            ).length;
            const dOffline = dm.filter(
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p
                    className={cn(
                      ...
                      (isNone || isEmpty) && "text-muted-foreground/60 italic",
                    )}
                  >
                    {label}
                  </p>
                  ...
                  <div className="flex -space-x-1.5 overflow-hidden">
                    {[...dm]
                      .sort((a, b) => {
                        ...
                        return (
                          (o[a.onlineStatus] ?? 5) - (o[b.onlineStatus] ?? 5)
                        );
                      })
                      .slice(0, 6)
                      .map((m) => (
                        <Tooltip key={m._id}>
                          <TooltipTrigger asChild>
                            <div
                              className={cn(
                                m.onlineStatus === "offline" && "opacity-40",
                              )}
                            >
                              <Avatar
                                className={cn(
                                  "size-5 border border-background ring-1",
                                  S.ring[m.onlineStatus as OnlineStatus],
                                )}
                              >
                                <AvatarImage src={m.avatar} />
                ...
                <div className="h-1 rounded-full bg-muted/40 overflow-hidden flex gap-px">
                  {dOnline > 0 && (
                    <div
                      ...
                      style={{
                        width: `${Math.round((dOnline / Math.max(dm.length, 1)) * 100)}%`,
                      }}
                    />
                  )}
                  {dBusy > 0 && (
                    <div
                      ...
                      style={{
                        width: `${Math.round((dBusy / Math.max(dm.length, 1)) * 100)}%`,
                      }}
                    />
                  )}
                  {dAway > 0 && (
                    <div
                      ...
                      style={{
                        width: `${Math.round((dAway / Math.max(dm.length, 1)) * 100)}%`,
                      }}
                    />
                  )}
                </div>
      ...
      {todayAbsences.length > 0 && (
        <div className="flex items-center gap-2 flex-wrap px-3.5 py-2.5 rounded-xl border border-amber-200/60 dark:border-amber-800/30 bg-amber-50/80 dark:bg-amber-950/20">
          <span className="text-[10px] font-black uppercase tracking-wide text-amber-700 dark:text-amber-400 shrink-0">
            Out today
          </span>
...
export default function TeamPulsePage() {
  ...
  const [noteAnnounce, setNoteAnnounce] =
    React.useState<AnnouncementType>("general");
  ...
  React.useEffect(() => {
    ...
    if (!me) return;
    setMyStatus((prev) =>
      (me.onlineStatus ?? "offline") !== prev
        ? (me.onlineStatus ?? "offline")
        : prev,
    );
  ...
  const counts = React.useMemo(
    () => ({
      ...
      do_not_disturb: members.filter((m) => m.onlineStatus === "do_not_disturb")
        .length,
    ...
    try {
      if (editNoteId) {
        ...
        if (noteAnnounce === "urgent")
          toast.error(`🚨 Urgent: ${noteTitle || noteBody.slice(0, 40)}`, {
            duration: 6000,
          });
        else if (noteAnnounce === "important")
          toast.warning(`⚠️ Important: ${noteTitle || noteBody.slice(0, 40)}`, {
            duration: 5000,
          });
  ...
  async function handleStatusChange(s: OnlineStatus) {
    ...
    try {
      ...
      toast.success(`Status → ${S.label[s]}`);
    } catch {
      setMyStatus(prev);
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="h-9 gap-2 font-semibold border-border/60 self-start sm:self-auto"
              >
                <span
                  className={cn("size-2.5 rounded-full", currentStatus.color)}
                />
                {currentStatus.label}
                {myCustomStatus && (
                  <span className="text-muted-foreground/50 text-xs hidden md:inline truncate max-w-18">
                    · {myCustomStatus}
                  </span>
                )}
            ...
            <DropdownMenuContent align="end" className="w-52 p-1.5">
              <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest px-2 py-1">
                Status
              </p>
              {onlineStatusOptions.map((opt) => (
                <DropdownMenuItem
                  key={opt.value}
                  onClick={() => handleStatusChange(opt.value as OnlineStatus)}
                  className="gap-2.5 rounded-lg cursor-pointer py-2 px-2"
                >
                  <span
                    className={cn("size-2.5 rounded-full shrink-0", opt.color)}
                  />
          ...
          <div className="flex gap-0 overflow-x-auto no-scrollbar">
            {(
              ...
              <button
                ...
                onClick={() => setTab(id)}
                className={cn(
                  "relative flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-3 text-xs sm:text-sm font-semibold transition-colors whitespace-nowrap shrink-0",
                  tab === id
                    ? "text-foreground"
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              {[
                ...
                },
                {
                  ...
                  Icon: CalendarDays,
                  label: "Team Calendar",
                  desc: `${todayAbsences.length} out today`,
                },
                {
                  id: "board" as TabId,
                  Icon: StickyNote,
                  label: "Bulletin Board",
                  desc: `${boardNotes.length} notes`,
                },
        ...
        {tab === "team" && (
          <div className="space-y-4">
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        on ? "text-background/60" : "text-muted-foreground/50",
                      )}
                    >
                      {c}
                    </span>
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              <span className="ml-auto text-[11px] text-muted-foreground/40 font-semibold tabular-nums shrink-0">
            ...
            {membersLoading ? (
              <div className="space-y-2">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div
                    key={i}
                    className="h-16.5 rounded-2xl bg-muted/20 animate-pulse border border-border/10"
                  />
                ))}
              </div>
            ) : filtered.length === 0 ? (
              ...
              <div
                className="space-y-2 overflow-y-auto no-scrollbar pr-1 pb-5 scroll-pb-5 overscroll-contain [scrollbar-gutter:stable]"
                style={{ maxHeight: 560 }}
              >
                {filtered.map((m) => (
                  <MemberCard
              ...
              {[
                {
                  ...
                  sub: `${monthStats.unique} unique people`,
                  icon: CalendarDays,
                ...
                },
                {
                  label: "Out Today",
                  value: todayAbsences.length,
                  sub: todayAbsences.length
                    ? "on leave / absent"
                    : "everyone in",
                  icon: Users,
                  bg: todayAbsences.length
                    ? "bg-amber-50 dark:bg-amber-950/30 border-amber-200/60 dark:border-amber-800/30"
                    : "bg-card border-border/40",
                  color: todayAbsences.length
                ...
                },
                {
                  ...
                  icon: Clock,
                  bg: "bg-violet-50 dark:bg-violet-950/30 border-violet-200/60 dark:border-violet-800/30",
                ...
                >
                  <div
                    className={cn(
                      "mt-0.5 p-1.5 rounded-lg bg-background/60 shrink-0",
                      s.color,
                    )}
                  >
                    <s.icon className="size-4" />
                  ...
                  <div className="relative flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1">
                      <Button
                        variant="ghost"
                        size="icon"
                        className="size-8 rounded-lg text-white/80 hover:bg-white/20 hover:text-white"
                        onClick={() =>
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-7 px-2.5 rounded-lg text-white/80 hover:bg-white/20 hover:text-white text-xs font-bold"
                      ...
                      <Button
                        ...
                        className="size-8 rounded-lg text-white/80 hover:bg-white/20 hover:text-white"
                        onClick={() =>
                          setCalMonth(new Date(calYear, calMonthNum, 1))
                        }
                      >
                  ...
                  <div className="relative mt-3 flex flex-wrap gap-2">
                    ...
                    >
                      <SelectTrigger className="h-7 text-xs w-auto bg-white/15 border-white/25 text-white [&>svg]:text-white/60 hover:bg-white/25">
                        <Building2 className="size-3 mr-1 text-white/70" />
                    ...
                    <Select
                      value={calTypeFilter}
                      onValueChange={setCalTypeFilter}
                    >
                      <SelectTrigger className="h-7 text-xs w-auto bg-white/15 border-white/25 text-white [&>svg]:text-white/60 hover:bg-white/25">
                        <Filter className="size-3 mr-1 text-white/70" />
                    ...
                    {(calDeptFilter !== "all" || calTypeFilter !== "all") && (
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-7 text-xs px-2 text-white/70 hover:bg-white/20 hover:text-white gap-1"
                        onClick={() => {
                            ...
                            {hits.length > 0 && (
                              <div className="flex flex-wrap gap-px mt-1 w-full justify-center z-10">
                                  ...
                                  return (
                                    <Tooltip key={a._id}>
                                      <TooltipTrigger asChild>
                                        <div
                                          className={cn(
                                            "rounded-full border-[1.5px] border-background overflow-hidden shrink-0",
                                            hits.length <= 2
                                              ? "size-4"
                                              : "size-3.5",
                                          )}
                                ...
                                {hits.length > maxAvatars && (
                                  <span
                                    className={cn(
                                      "text-[7px] font-black flex items-center justify-center rounded-full shrink-0",
                                      hits.length <= 2 ? "size-4" : "size-3.5",
                                      isSel
                ...
                {upcomingAbsences.length > 0 && (
                  <Card className="border-border/40 shadow-sm overflow-hidden">
                    <div className="bg-linear-to-r from-violet-500/10 to-transparent border-b border-border/20 px-4 py-3 flex items-center gap-2">
                      ...
                      <span className="ml-auto text-[10px] font-black text-violet-600 dark:text-violet-400">
                      ...
                      <CardContent className="px-3 pb-3 pt-2.5 space-y-1.5">
                        {upcomingAbsences.map((a) => {
                          ...
                          return (
                            <div
                              key={a._id}
                              className="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg border border-border/20 hover:bg-muted/20 transition-colors"
                            >
                      ...
                      {dayAbsences.length > 0 && (
                        ...
                        >
                          {dayAbsences.map((a) => {
                            const cfg = A[a.type as AbsenceType];
                            const canDel =
                              a.userName === user?.fullName || isAdmin;
                            const liveAvatar = members.find(
                              (m) => m.name === a.userName,
                            )?.avatar;
                            return (
                              ...
                              >
                                ...
                                {canDel && (
                                  <Button
                                    variant="ghost"
                                    size="icon"
                                    className="size-6 shrink-0 opacity-40 hover:opacity-100 hover:text-destructive"
                      ...
                      {myDayAbsence ? (
                        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-muted/30 border border-border/20">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              handleDeleteAbsence(myDayAbsence._id)
                            }
                          >
                            <Trash2 className="size-3" />
                            Remove
                  ...
                  <Card className="border-dashed border-border/30 bg-card/50">
                    <CardContent className="flex flex-col items-center justify-center py-10 text-center px-6">
                      ...
                      <p className="text-[11px] text-muted-foreground/50 mt-1 leading-relaxed max-w-48">
                        Click any date on the calendar to view entries or mark
                        your availability.
                      </p>
                    </CardContent>
                  </Card>
              ...
              <div className="space-y-4">
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "inset 0 2px 12px rgba(0,0,0,0.25), inset 0 -2px 6px rgba(0,0,0,0.15), 0 4px 20px rgba(0,0,0,0.18)",
                  }}
                >
                  <div
                    ...
                    `,
                      backgroundSize:
                        "100% 100%, 100% 100%, 100% 100%, 12px 12px, 20px 20px, 8px 8px",
                    }}
                  />
                  ...
                  <div className="relative flex flex-col sm:flex-row sm:items-start justify-between gap-4 px-5 py-4">
                    <div className="flex flex-col gap-2.5">
                      <div className="inline-flex items-center gap-2 bg-amber-50/95 dark:bg-zinc-900/90 border border-amber-200/60 dark:border-zinc-700/60 rounded-lg px-3.5 py-2 shadow-md self-start">
                        ...
                        <span className="font-black text-sm text-amber-900 dark:text-amber-100 tracking-tight">
                          Team Bulletin Board
                        </span>
                      </div>
                      <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <div className="flex gap-1.5 overflow-x-auto no-scrollbar pb-0.5">
                    {(
                      [
                        ...
                        ...Object.entries(ANNOUNCE_CONFIG).map(
                          ([key, cfg]) => ({
                            key,
                            label: cfg.label,
                            Icon: cfg.icon,
                ...
                {boardLoading ? (
                  ...
                  >
                    {Array.from({ length: 6 }).map((_, i) => (
                      <div
                        key={i}
                        className="break-inside-avoid mb-6 h-36 rounded-xl bg-muted/20 animate-pulse border border-border/10"
                      />
                    ))}
                  </div>
                ) : boardNotes.length === 0 ? (
                  ...
                  >
                    <div className="relative mb-4" style={{ paddingTop: 20 }}>
                      ...
                      <div
                        className={cn(
                          "rounded-xl border px-8 py-5 shadow-md",
                          N.yellow.bg,
                        )}
                        style={{
                      ...
                      >
                        <p className="text-sm font-black text-amber-900/70">
                          No notes yet…
                        </p>
                    ...
                    <Button
                      onClick={openNewNote}
                      className="gap-2 bg-amber-700 hover:bg-amber-600 text-white border-0 shadow-md mt-2"
                    >
                      <Plus className="size-4" />
                      Pin the First Note
                    </Button>
                    ...
                    {filteredNotes.map((note, i) => (
                      <div key={note._id} className="break-inside-avoid mb-7">
                        <NoteCard
                          note={note}
                          index={i}
                          isMe={note.userName === user?.fullName}
                          isAdmin={isAdmin}
                          onDelete={() =>
                            deleteNote
        ...
        <DialogContent className="w-[calc(100%-2rem)] sm:w-full sm:max-w-lg max-h-[92vh] overflow-y-auto p-0 rounded-2xl">
          ...
          <div className="relative overflow-hidden rounded-t-xl px-6 py-4 border-b border-amber-200/60 dark:border-amber-800/40 bg-amber-50 dark:bg-amber-950/40">
            <div
              ...
              style={{
                backgroundImage:
                  "radial-gradient(circle at 1.5px 1.5px, rgba(120,80,30,0.3) 1.5px, transparent 0)",
            ...
            <DialogHeader className="relative">
              <DialogTitle className="flex items-center gap-2.5 text-base font-black text-amber-900 dark:text-amber-100">
                {editNoteId ? (
                  <>
                    <Edit2 className="size-4 text-amber-700 dark:text-amber-400" />
                    Edit Note
                  </>
                ) : (
                  <>
                    <Pin className="size-4 text-amber-700 dark:text-amber-400" />
                    Pin a New Note
                  </>
                )}
              </DialogTitle>
              <p className="text-[11px] text-amber-700/60 dark:text-amber-300/50 mt-0.5">
                {editNoteId
                  ? "Update your note on the board"
                  : "Add a note to the team bulletin board"}
              </p>
            </DialogHeader>
          </div>
            ...
            <div className="flex gap-2">
              <div className="space-y-1.5 w-16 shrink-0">
                ...
                <Input
                  ...
                  placeholder="🔔"
                  className="h-9 text-lg text-center"
                  maxLength={2}
                />
              </div>
              <div className="space-y-1.5 flex-1">
                ...
                <Input
                  ...
                  placeholder="Announcement, Reminder, FYI…"
              ...
              <>
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {(
                      Object.entries(ANNOUNCE_CONFIG) as [
                        AnnouncementType,
                        any,
                      ][]
                    ).map(([type, cfg]) => {
                ...
                <div className="space-y-1.5">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        className="w-full justify-start text-left h-9 text-sm font-normal"
                      >
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(day) =>
                          setNoteExpiry(day ? format(day, "yyyy-MM-dd") : "")
                        }
                    ...
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className={cn(
                          ...
                          noteColor === c
                            ? "border-foreground/40 scale-[1.15] shadow-lg"
                            : "border-transparent hover:scale-110 opacity-55 hover:opacity-90",
                        )}
                      />
                    </TooltipTrigger>
