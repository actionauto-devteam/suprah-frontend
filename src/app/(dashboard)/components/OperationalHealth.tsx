...
export function OperationalHealth({ metrics, isLoading }: OperationalHealthProps) {
  ...
  return (
    <Card className="border-border/40 bg-card/50 backdrop-blur-sm overflow-hidden flex flex-col p-0">
      <CardHeader className="py-2.5 px-3 sm:py-5 sm:px-6 border-b border-border/10">
        <CardTitle className="text-xs sm:text-sm font-black uppercase tracking-widest text-primary">
          Pipeline Status
        </CardTitle>
        <CardDescription className="hidden sm:block text-xs font-bold text-muted-foreground/50 italic">
          Throughput &amp; Capacity
        </CardDescription>
      </CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-10">
          <div className="space-y-1.5 sm:space-y-4">
            <div className="flex justify-between items-end">
              <h4 className="text-sm sm:text-lg font-black tracking-tighter">Inventory Turnover</h4>
              <span className="text-[10px] font-bold text-primary tabular-nums">75%</span>
            </div>
            <div className="h-1.5 sm:h-2 w-full bg-muted/30 rounded-full overflow-hidden">
              <div className="h-full bg-primary rounded-full" style={{ width: '75%' }} />
            </div>
            <p className="hidden sm:block text-[9px] font-bold text-muted-foreground/40 uppercase tracking-widest">
          ...
          <div className="space-y-1.5 sm:space-y-4">
            <div className="flex justify-between items-end">
              <h4 className="text-sm sm:text-lg font-black tracking-tighter">Quote Conversion</h4>
          ...
          <div className="space-y-1.5 sm:space-y-4">
            <div className="flex justify-between items-end">
              <h4 className="text-sm sm:text-lg font-black tracking-tighter">Network Health</h4>
