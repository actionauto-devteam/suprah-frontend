                    ...
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            {error instanceof Error
                                ? error.message
                                : "The driver directory request failed. Please try again."}
                        </CardDescription>
                    </CardHeader>
    ...
    return (
        <div className="space-y-6 container mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">Drivers</h2>
                    <p className="text-muted-foreground text-sm sm:text-base">
                        Review applications and manage the shared driver pool across every organization.
                    </p>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Every driver account on the platform, regardless of which org they applied through.
                    </CardDescription>
                </CardHeader>
                <CardContent>
